...
mkButton :: UI t m => TransitionType
...
mkImages :: UI t m => Text -> Event t TransitionType -> m ()
...
mkButtons :: UI t m => Text -> [TransitionType] -> m ()
mkButtons _ [] = return ()
...
transitions :: UI t m => Section t m
